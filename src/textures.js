...
import { TILE_PX, ATLAS_COLS, ATLAS_ROWS, tileUV, tileRect } from './tuiles.js';
export { TILE_PX, ATLAS_COLS, ATLAS_ROWS, tileUV, tileRect };
// (les tuiles elles-mêmes — colonnes, rangées, UV — vivent dans tuiles.js
// depuis la v251, parce que le mailleur tourne dans un worker sans three)
